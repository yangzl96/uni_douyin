			...
			<cell :recycle="false" 
				...
				<view class="operation-box">
					<view class="operation-face-box">
						<image :src="item.user.vlogerFace" class="user-face" @click="goUserInfoSeeSee(item.user.vlogerId)"></image>
					</view>
					<image v-if="!item.doIFollowVloger && userId != item.user.vlogerId" 
					...
					<view class="like-box">
						...
						<image v-if="item.doILikeThisVlog" 
							...
							class="icon"></image>
						<text class="some-counts">{{item.like_counts}}</text>
					</view>
